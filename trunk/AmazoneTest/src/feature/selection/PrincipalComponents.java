...
public class PrincipalComponents 
  ...
  implements AttributeTransformer, OptionHandler {
	...
	private static class Matrix { 
		public final DoubleMatrix2D matrix;
		public Matrix(double[][] data) {
			matrix = new SparseDoubleMatrix2D(data);
		}
  ...
  private void buildAttributeConstructor (Instances data) throws Exception {
    ...
    System.out.println("filling covariance");
    //fillCorrelation();
    fillCovariance();
    ...
    EigenvalueDecomposition egd = corr.eigenvalueDecomposition();
    m_eigenvectors = egd.getD().toArray();
    m_eigenvalues = egd.getRealEigenvalues().toArray();
    System.out.println("eigenvectors found");
    //end of changes
